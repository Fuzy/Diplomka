...
\item the Internet media type of the data supported by the web API. This is often JSON but can be any other valid Internet media type provided that it is a valid hypertext standard.
...
\item
\end{itemize}
\item The API must be hypertext driven.
\end{itemize}
...
\subsection{Srovnání a výběr}
rest auth pri kazdem pozadavku
