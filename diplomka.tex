...
Při návrhu REST služby jsem nejprve identifikoval všechny zdroje, které webová služba zpřístupňuje. Jedná se o údaje o docházce zaměstnanců, výkazech práce a zaměstnancích samotných. 
 \par
...
\newpage
\begin{lstlisting}[language=Java, caption={Ukázka použití JAX-RS},label={lis:jaxrs}]
@Path("/events")
...
\begin{lstlisting}[language=Java, caption={Ukázka použití RestTemplate},label={lis:rest}]
